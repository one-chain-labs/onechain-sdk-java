...
public abstract class ExecutionFailureStatus {
    ...
    public static ExecutionFailureStatus deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            case 10: return OneChainMoveVeOnerificationError.load(deserializer);
    ...
    public static final class OneChainMoveVeOnerificationError extends ExecutionFailureStatus {
        public OneChainMoveVeOnerificationError() {
        }
        ...
        static OneChainMoveVeOnerificationError load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            deserializer.decrease_container_depth();
            return builder.build();
        ...
        public boolean equals(Object obj) {
            ...
            if (obj == null) return false;
            if (getClass() != obj.getClass()) return false;
            OneChainMoveVeOnerificationError other = (OneChainMoveVeOnerificationError) obj;
            return true;
        }
        ...
        public static final class Builder {
            public OneChainMoveVeOnerificationError build() {
                return new OneChainMoveVeOnerificationError(
                );
            }
        }
    }
    ...
    public static final class CommandArgumentError extends ExecutionFailureStatus {
        ...
        public final io.onechain.bcsgen.CommandArgumentError kind;

        public CommandArgumentError(@com.novi.serde.Unsigned Short arg_idx, io.onechain.bcsgen.CommandArgumentError kind) {
        ...
        static CommandArgumentError load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.kind = io.onechain.bcsgen.CommandArgumentError.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            ...
            public io.onechain.bcsgen.CommandArgumentError kind;
    ...
    public static final class TypeArgumentError extends ExecutionFailureStatus {
        ...
        public final io.onechain.bcsgen.TypeArgumentError kind;

        public TypeArgumentError(@com.novi.serde.Unsigned Short argument_idx, io.onechain.bcsgen.TypeArgumentError kind) {
        ...
        static TypeArgumentError load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.kind = io.onechain.bcsgen.TypeArgumentError.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            ...
            public io.onechain.bcsgen.TypeArgumentError kind;
    ...
    public static final class PackageUpgradeError extends ExecutionFailureStatus {
        public final io.onechain.bcsgen.PackageUpgradeError upgrade_error;

        public PackageUpgradeError(io.onechain.bcsgen.PackageUpgradeError upgrade_error) {
        ...
        static PackageUpgradeError load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.upgrade_error = io.onechain.bcsgen.PackageUpgradeError.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public io.onechain.bcsgen.PackageUpgradeError upgrade_error;
