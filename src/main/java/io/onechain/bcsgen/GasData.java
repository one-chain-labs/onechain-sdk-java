...
public final class GasData {
    ...
    public final OneChainAddress owner;
    public final @com.novi.serde.Unsigned Long price;
    public final @com.novi.serde.Unsigned Long budget;

    public GasData(java.util.List<com.novi.serde.Tuple3<ObjectID, SequenceNumber, ObjectDigest>> payment, OneChainAddress owner, @com.novi.serde.Unsigned Long price, @com.novi.serde.Unsigned Long budget) {
    ...
    public static GasData deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.owner = OneChainAddress.deserialize(deserializer);
