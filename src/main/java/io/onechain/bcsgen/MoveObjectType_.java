...
public abstract class MoveObjectType_ {
    ...
    public static MoveObjectType_ deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            case 2: return StakedOneChain.load(deserializer);
    ...
    public static final class StakedOneChain extends MoveObjectType_ {
        public StakedOneChain() {
        }
        ...
        static StakedOneChain load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            deserializer.decrease_container_depth();
            return builder.build();
        ...
        public boolean equals(Object obj) {
            ...
            if (obj == null) return false;
            if (getClass() != obj.getClass()) return false;
            StakedOneChain other = (StakedOneChain) obj;
            return true;
        }
        ...
        public static final class Builder {
            public StakedOneChain build() {
                return new StakedOneChain(
                );
            }
        }
    }
