...
public abstract class TransactionKind {
    ...
    public static final class ProgrammableTransaction extends TransactionKind {
        public final io.onechain.bcsgen.ProgrammableTransaction value;

        public ProgrammableTransaction(io.onechain.bcsgen.ProgrammableTransaction value) {
        ...
        static ProgrammableTransaction load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.value = io.onechain.bcsgen.ProgrammableTransaction.deserialize(deserializer);
        ...
        public static final class Builder {
            public io.onechain.bcsgen.ProgrammableTransaction value;
    ...
    public static final class ChangeEpoch extends TransactionKind {
        public final io.onechain.bcsgen.ChangeEpoch value;

        public ChangeEpoch(io.onechain.bcsgen.ChangeEpoch value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static ChangeEpoch load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = io.onechain.bcsgen.ChangeEpoch.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public io.onechain.bcsgen.ChangeEpoch value;
    ...
    public static final class ConsensusCommitPrologue extends TransactionKind {
        public final io.onechain.bcsgen.ConsensusCommitPrologue value;

        public ConsensusCommitPrologue(io.onechain.bcsgen.ConsensusCommitPrologue value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static ConsensusCommitPrologue load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = io.onechain.bcsgen.ConsensusCommitPrologue.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public io.onechain.bcsgen.ConsensusCommitPrologue value;
