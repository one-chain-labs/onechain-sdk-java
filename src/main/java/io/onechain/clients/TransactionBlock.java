...
import static io.onechain.bcsgen.CallArg.Pure.Builder;
...
import io.onechain.bcsgen.MoveValue.Bool;
import io.onechain.bcsgen.MoveValue.U8;
import io.onechain.bcsgen.MoveValue.Vector;
import io.onechain.bcsgen.ObjectArg.ImmOrOwnedObject;
import io.onechain.bcsgen.ObjectArg.SharedObject;
import io.onechain.bcsgen.TransactionData.V1;
import io.onechain.bcsgen.TransactionExpiration.Epoch;
import io.onechain.bcsgen.TypeTag.bool;
import io.onechain.bcsgen.TypeTag.u128;
import io.onechain.bcsgen.TypeTag.u16;
import io.onechain.bcsgen.TypeTag.u256;
import io.onechain.bcsgen.TypeTag.u32;
import io.onechain.bcsgen.TypeTag.u64;
import io.onechain.bcsgen.TypeTag.u8;
import io.onechain.models.objects.MoveNormalizedFunction;
import io.onechain.models.objects.MoveNormalizedType;
import io.onechain.models.objects.MoveNormalizedType.MoveNormalizedStructType;
import io.onechain.models.objects.MoveNormalizedType.MoveNormalizedStructType.Struct;
import io.onechain.models.objects.MoveNormalizedType.MutableReferenceMoveNormalizedType;
import io.onechain.models.objects.MoveNormalizedType.TypeMoveNormalizedType;
import io.onechain.models.objects.MoveNormalizedType.VectorReferenceMoveNormalizedType;
import io.onechain.models.objects.ObjectDataOptions;
import io.onechain.models.objects.ObjectResponseQuery;
import io.onechain.models.objects.PaginatedObjectsResponse;
import io.onechain.models.objects.OneChainObjectData;
import io.onechain.models.objects.OneChainObjectOwner;
import io.onechain.models.objects.OneChainObjectRef;
import io.onechain.models.objects.OneChainRawData;
...
public class TransactionBlock {
    ...
    private static final Struct RESOLVED_ONE_CHAIN_ID = new Struct();
    private static final Struct RESOLVED_STD_OPTION = new Struct();
    private static final String GAS_COIN_TYPE = "0x2::coin::Coin<0x2::oct::OCT>";
    ...
    static {
        ...
        RESOLVED_ONE_CHAIN_ID.setAddress("0x2");
        RESOLVED_ONE_CHAIN_ID.setModule("object");
        RESOLVED_ONE_CHAIN_ID.setName("ID");
    ...
    private OneChainAddress sender;

    private boolean useSelfGas = true;
    private TransactionExpiration transactionExpiration =
            new TransactionExpiration.None.Builder().build();

    private final static ConcurrentHashMap<String, CompletableFuture<ObjectArg>> GLOBAL_SHARED_OBJECT_CACHE = new ConcurrentHashMap<>();

    public final static ThreadLocal<ConcurrentHashMap<String, CompletableFuture<ObjectArg>>> THREAD_OBJECT_CACHE = new ThreadLocal<>();
    ...
    public TransactionBlock(QueryClient queryClient,boolean useSelfGas) {
        this.queryClient = queryClient;
        this.programmableTransactionBuilder = new ProgrammableTransactionBuilder();
        this.gasBuilder = new GasData.Builder();
        this.useSelfGas = useSelfGas;
    }
    ...
    public void setSender(String sender) {
        ...
        final OneChainAddress.Builder senderAddressBuilder = new OneChainAddress.Builder();
                ...
                .thenAccept(
                        unused -> {
                            ...
                            if (StringUtils.isNotEmpty(owner)) {
                                ...
                                final OneChainAddress.Builder ownerAddressBuilder = new OneChainAddress.Builder();
...
//                                    gasDataBuilder.payment = this.gasBuilder.payment;
                                    gasDataBuilder.payment = Lists.newArrayList();
     ...
     */
    @SuppressWarnings("unchecked")
    public CompletableFuture<Argument> makeMoveVec(List<Boolean> mutables, List<String> args, ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap) {
        CompletableFuture<ObjectArg>[] callArgFutures =
                (CompletableFuture<ObjectArg>[])
                        Streams.zip(args.stream(), mutables.stream(), (a, b) -> this.newObjectArg(a, b, threadObjectMap))
                                .toArray(CompletableFuture[]::new);
    ...
    public CompletableFuture<Argument> transferObjects(List<String> suiObjects, String recipient) {
        ...
        final OneChainAddress.Builder recipientAddressBuilder = new OneChainAddress.Builder();
    ...
    public Argument moveCall1(
        ...
        final List<io.onechain.bcsgen.TypeTag> bcsTypeArguments =
    ...
    public CompletableFuture<Argument> moveCall(
            ...
            List<io.onechain.models.transactions.TypeTag> typeArguments,
            List<?> arguments,
            ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap) {
        List<io.onechain.bcsgen.TypeTag> bcsTypeArguments =
                typeArguments.stream().map(this::toBcsTypeTag).collect(Collectors.toList());
                                    ...
                                    (CompletableFuture<CallArg>[])
                                            Streams.zip(
                                                            ...
                                                            (BiFunction<MoveNormalizedType, Object, CompletableFuture<CallArg>>)
                                                                    (a, b) -> this.toBcsCallArg(a, b, threadObjectMap))
                                                    .toArray(CompletableFuture[]::new);
                            return CompletableFuture.allOf(callArgFutures)
                                    .thenApply(
                                            unused -> {
    ...
    public CompletableFuture<Argument> multipleMoveCall(List<MoveCallParam> params) {
        ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap = new ConcurrentHashMap<>();
        AtomicReference<CompletableFuture<Argument>> argumentCompletableFuture = new AtomicReference<>();
        try {
            for (MoveCallParam param : params) {
                CompletableFuture<Argument> future = moveCall(param.getPackageObjectId(), param.getModule(), param.getFunction(), param.getTypeArguments(), param.getArguments(), threadObjectMap);
                argumentCompletableFuture.set(CompletableFuture.completedFuture(future.get()));
            }
        } catch (Throwable e) {
            throw new RuntimeException(e);
        }
        return argumentCompletableFuture.get();
    }
    ...
    @SuppressWarnings("unchecked")
    private CompletableFuture<OneChainObjectRef> selectGas(
        ...
        return queryClient
                ...
                .thenCompose(
                        (Function<PaginatedObjectsResponse, CompletableFuture<OneChainObjectRef>>)
                                paginatedObjectsResponse -> {
                                    CompletableFuture<Optional<OneChainObjectRef>>[] gases =
                                            (CompletableFuture<Optional<OneChainObjectRef>>[])
                                                            ...
                                                            .map(
                                                                    objectResponse -> {
                                                                        ...
                                                                        return CompletableFuture
                                                                                .<Optional<OneChainObjectRef>>completedFuture(Optional.empty());
                                                                    })
                                                            .toArray(CompletableFuture[]::new);
                                    ...
                                    return CompletableFuture.allOf(gases)
                                            .thenApply(
                                                    unused -> {
                                                        Optional<Optional<OneChainObjectRef>> selected =
                                                                Arrays.stream(gases)
                                                                        .map(CompletableFuture::join)
                                                                        .filter(Optional::isPresent)
                                                                        .findFirst();
    ...
    @NotNull
    private Builder getPureBuilder(MoveValue moveValue) {
    ...
    private Optional<MoveValue> toPureMoveValue(
        ...
        if (moveNormalizedType instanceof MoveNormalizedType.MoveNormalizedStructType) {
            ...
            if (argStruct.equals(RESOLVED_ASCII_STR)) {
                ...
                return Optional.of(moveValue);
            } else if (argStruct.equals(RESOLVED_ONE_CHAIN_ID)) {
                checkArgType(moveNormalizedType, argVal, String.class);
        ...
        if (moveNormalizedType instanceof MoveNormalizedType.VectorReferenceMoveNormalizedType) {
            if (((MoveNormalizedType.VectorReferenceMoveNormalizedType) moveNormalizedType).getVector()
                ...
                MoveValue.Vector.Builder vectorBuilder = new MoveValue.Vector.Builder();
                vectorBuilder.value =
//                        Arrays.stream(ArrayUtils.toObject(Base64.decode(((String) argVal))))
                        Arrays.stream(ArrayUtils.toObject(((String) argVal).getBytes(StandardCharsets.UTF_8)))
                                .map(
                                        (Function<Byte, MoveValue>)
                                                b -> {
    ...
    private CompletableFuture<CallArg> toBcsCallArg(
            MoveNormalizedType moveNormalizedType, java.lang.Object argVal, ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap) {
        ...
        if (moveNormalizedType instanceof MoveNormalizedType.VectorReferenceMoveNormalizedType) {
            ...
            if (((MoveNormalizedType.VectorReferenceMoveNormalizedType) moveNormalizedType).getVector()
                ...
                List<String> argValList = (List<String>) argVal;
                CompletableFuture<ObjectArg>[] objectArgFutures =
                        (CompletableFuture<ObjectArg>[])
                                Arrays.stream(argValList.toArray())
                                        .map(objectId -> newObjectArg((String) objectId, moveNormalizedType, threadObjectMap))
                                        .toArray(CompletableFuture[]::new);
        ...
        if (structOptional.isPresent()
            ...
            return newObjectArg((String) argVal, moveNormalizedType, threadObjectMap)
                    .thenApply(
                            objectArg -> {
                                final io.onechain.bcsgen.CallArg.Object.Builder objectBuilder =
    ...
    private CompletableFuture<ObjectArg> newObjectArg(String objectId, boolean mutable, ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap) {
        ObjectDataOptions queryOptions = new ObjectDataOptions();
        queryOptions.setShowOwner(true);
        CompletableFuture<ObjectArg> objectArgCompletableFuture = GLOBAL_SHARED_OBJECT_CACHE.get(objectId);
        if (Objects.nonNull(objectArgCompletableFuture)) {
            return objectArgCompletableFuture;
        }
        if (Objects.nonNull(threadObjectMap)) {
            CompletableFuture<ObjectArg> argCompletableFuture = threadObjectMap.get(objectId);
            if (Objects.nonNull(argCompletableFuture)) {
                return argCompletableFuture;
            }
        }
        //todo 优化点 做缓存
        return queryClient
                ...
                .thenApply(
                        objectResponse -> {
                            ...
                            final OneChainObjectData objectData = objectResponse.getData();
                            final OneChainObjectOwner owner = objectData.getOwner();
                            if (owner instanceof OneChainObjectOwner.SharedOwner) {
                                AccountAddress.Builder accountAddressBuilder = new AccountAddress.Builder();
                                accountAddressBuilder.value = geAddressBytes(objectId);
                                ObjectID.Builder objectIdBuilder = new ObjectID.Builder();
                                objectIdBuilder.value = accountAddressBuilder.build();
                                ...
                                seqBuilder.value =
                                        ((OneChainObjectOwner.SharedOwner) owner)
                                                .getShared()
                                ...
                                sharedObjectBuilder.mutable = false;

                                if (mutable) {
                                    sharedObjectBuilder.mutable = true;
                                }
                                SharedObject build = sharedObjectBuilder.build();
                                GLOBAL_SHARED_OBJECT_CACHE.put(objectId, CompletableFuture.completedFuture(build));
                                return build;
                            }
                            ...
                            ImmOrOwnedObject build = immOrOwnedObjectBuilder.build();
                            if (Objects.nonNull(threadObjectMap)) {
                                threadObjectMap.put(objectId, CompletableFuture.completedFuture(build));
                            }
                            return build;
                        });
    }
    ...
    private CompletableFuture<ObjectArg> newObjectArg(
            String objectId, MoveNormalizedType moveNormalizedType, ConcurrentHashMap<String, CompletableFuture<ObjectArg>> threadObjectMap) {
        return newObjectArg(objectId, moveNormalizedType instanceof MutableReferenceMoveNormalizedType, threadObjectMap);
    }
     ...
     */
    @NotNull
    public List<Byte> geAddressBytes(String address) {
    ...
    private Tuple3<ObjectID, SequenceNumber, ObjectDigest> getObjectRef(OneChainObjectRef objRef) {
        AccountAddress.Builder addressBuilder = new AccountAddress.Builder();
    ...
    private io.onechain.bcsgen.TypeTag toBcsTypeTag(io.onechain.models.transactions.TypeTag typeTag) {
        if (typeTag instanceof io.onechain.models.transactions.TypeTag.SimpleType) {
            switch ((io.onechain.models.transactions.TypeTag.SimpleType) typeTag) {
                case u8:
                    io.onechain.bcsgen.TypeTag.u8.Builder u8builder = new u8.Builder();
                    return u8builder.build();
                case u16:
                    io.onechain.bcsgen.TypeTag.u16.Builder u16builder = new u16.Builder();
                    return u16builder.build();
                case u32:
                    io.onechain.bcsgen.TypeTag.u32.Builder u32builder = new u32.Builder();
                    return u32builder.build();
                case u64:
                    io.onechain.bcsgen.TypeTag.u64.Builder u64builder = new u64.Builder();
                    return u64builder.build();
                case bool:
                    io.onechain.bcsgen.TypeTag.bool.Builder boolBuilder = new bool.Builder();
                    return boolBuilder.build();
                case u128:
                    io.onechain.bcsgen.TypeTag.u128.Builder u128builder = new u128.Builder();
                    return u128builder.build();
                case u256:
                    io.onechain.bcsgen.TypeTag.u256.Builder u256builder = new u256.Builder();
                    return u256builder.build();
                case signer:
                    io.onechain.bcsgen.TypeTag.signer.Builder signerBuilder =
                            new io.onechain.bcsgen.TypeTag.signer.Builder();
                    return signerBuilder.build();
                case address:
                    io.onechain.bcsgen.TypeTag.address.Builder addressBuilder =
                            new io.onechain.bcsgen.TypeTag.address.Builder();
                    return addressBuilder.build();
                default:
                    throw new NotSupportedTypeTagException();
            }
        } else if (typeTag instanceof io.onechain.models.transactions.TypeTag.VectorType) {
            io.onechain.bcsgen.TypeTag.vector.Builder vectorBuilder =
                    new io.onechain.bcsgen.TypeTag.vector.Builder();
            vectorBuilder.value =
                    toBcsTypeTag(((io.onechain.models.transactions.TypeTag.VectorType) typeTag).getTypeTag());
            return vectorBuilder.build();
        } else {
            AccountAddress.Builder addressBuilder = new AccountAddress.Builder();
            addressBuilder.value =
                    geAddressBytes(
                            ((io.onechain.models.transactions.TypeTag.StructType) typeTag)
                                    .getStructTag()
                                    .getAddress());
            Identifier.Builder moduleBuilder = new Identifier.Builder();
            moduleBuilder.value =
                    ((io.onechain.models.transactions.TypeTag.StructType) typeTag).getStructTag().getModule();
            Identifier.Builder nameBuilder = new Identifier.Builder();
            nameBuilder.value =
                    ((io.onechain.models.transactions.TypeTag.StructType) typeTag).getStructTag().getName();
            ...
            structTagBuilder.type_args =
                    ((io.onechain.models.transactions.TypeTag.StructType) typeTag)
                            ...
                            .collect(Collectors.toList());
            io.onechain.bcsgen.TypeTag.struct.Builder structBuilder =
                    new io.onechain.bcsgen.TypeTag.struct.Builder();
