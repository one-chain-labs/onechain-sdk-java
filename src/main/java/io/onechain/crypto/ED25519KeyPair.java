...
public class ED25519KeyPair extends OneChainKeyPair<AsymmetricCipherKeyPair> {
  ...
  @Override
  public byte[] toOneChainPublicKeyBytes() {
    return prepend(publicKeyBytes(), signatureScheme().getScheme());
