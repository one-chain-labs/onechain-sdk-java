...
package io.onechain.models.events;
...
/**
 * The type onechain event.
 *
 * @author chiyu
 * @since 2023.03
 */
public class OneChainEvent {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OneChainEvent)) {
      return false;
    }
    OneChainEvent oneChainEvent = (OneChainEvent) o;
    return id.equals(oneChainEvent.id)
        && packageId.equals(oneChainEvent.packageId)
        && transactionModule.equals(oneChainEvent.transactionModule)
        && sender.equals(oneChainEvent.sender)
        && type.equals(oneChainEvent.type)
        && parsedJson.equals(oneChainEvent.parsedJson)
        && bcs.equals(oneChainEvent.bcs)
        && timestampMs.equals(oneChainEvent.timestampMs);
  }
