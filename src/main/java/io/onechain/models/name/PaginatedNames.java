...
package io.onechain.models.name;
 ...
 * @since 2022.11
 */
public class PaginatedNames {

  private List<OneChainEvent> data;
   ...
   * @return the data
   */
  public List<OneChainEvent> getData() {
    return data;
  }
   ...
   * @param data the data
   */
  public void setData(List<OneChainEvent> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PaginatedNames)) {
      return false;
    }
    PaginatedNames that = (PaginatedNames) o;
