...
public abstract class InputObjectKind {
  ...
  public static class ImmOrOwnedMoveObjectKind extends InputObjectKind {
    ...
    private OneChainObjectRef ImmOrOwnedMoveObject;
     ...
     */
    public OneChainObjectRef getImmOrOwnedMoveObject() {
     ...
     */
    public void setImmOrOwnedMoveObject(OneChainObjectRef immOrOwnedMoveObject) {
