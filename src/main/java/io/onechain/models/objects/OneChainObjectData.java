 ...
 * @since 2022.11
 */
public class OneChainObjectData {
  ...
  private OneChainParsedData content;

  private OneChainRawData bcs;
   ...
   * @return the content
   */
  public OneChainParsedData getContent() {
    return content;
  }
   ...
   */
  public void setContent(OneChainParsedData content) {
   ...
   * @param bcs the bcs
   */
  public void setBcs(OneChainRawData bcs) {
    this.bcs = bcs;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OneChainObjectData)) {
      return false;
    }
    OneChainObjectData that = (OneChainObjectData) o;
   ...
   * @return the ref
   */
  public OneChainObjectRef getRef() {
    OneChainObjectRef oneChainObjectRef = new OneChainObjectRef();
    oneChainObjectRef.setObjectId(this.objectId);
    oneChainObjectRef.setDigest(this.digest);
    oneChainObjectRef.setVersion(this.version);
    return oneChainObjectRef;
  }
}
