 ...
 * @since 2022.11
 */
public interface OneChainObjectOwner {

  /** The enum String sui object owner. */
  enum StringOneChainObjectOwner implements OneChainObjectOwner {
    /** Immutable string sui object owner. */
    Immutable
  }

  /** The type Address owner. */
  class AddressOwner implements OneChainObjectOwner {
  ...
  class ObjectOwner implements OneChainObjectOwner {
  ...
  class SharedOwner implements OneChainObjectOwner {
