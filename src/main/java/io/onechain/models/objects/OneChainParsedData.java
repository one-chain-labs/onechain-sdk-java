 ...
 * @since 2023.03
 */
public abstract class OneChainParsedData {

    /** The type Move object. */
    public static class MoveObject extends OneChainParsedData {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(type, dataType, fields, hasPublicTransfer);
        }
    ...
    public static class PackageObject extends OneChainParsedData {
